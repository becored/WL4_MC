// @Description MC6_8010E48_WarKeySJump
...
int MC_Sub_8010E48_WarKeySJump() {
		int v1;
		// Vanilla code
		WarioLift_LOBYTE = 0;
	   if ( !Wario_ucJTimer )
	   {
	 		...
	 		// Custom Code
	 		if ( (usTrg_KeyPress1Frame[0] & 1 || Wario_ucJpNext) && airJumpNum > 0 && !Sub_8014090_WarHeadCheck(0, 0xFFA8, 1)) // Press A
	 		{
	 			airJumpNum--;
	 			crystal_Tflg = 1;
	 			Wario_ucJpFlg = 1;
