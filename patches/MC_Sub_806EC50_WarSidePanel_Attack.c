// @Description MC_Sub_806EC50_WarSidePanel_Attack
// @HookAddress 0x6EC54
...
int MC_Sub_806EC50_WarSidePanel_Attack(unsigned short Ypos,unsigned short Xpos)
{
	unsigned int v2;
	unsigned int v3;
  char v4;
...
LABEL_12:
				...
				switch (pDestroy.part)
				{
					// Hard block (1 x 1)
					case YBLOCK_HA_1:
							if ( Wario_ucStat == DATTACK || Wario_ucStat == DAJUMP ) {
