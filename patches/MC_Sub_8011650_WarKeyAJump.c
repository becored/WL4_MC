// @Description MC_Sub_8011650_WarKeyAJump
...
int MC_Sub_8011650_WarKeyAJump() {
    // Vanilla code
		signed int result;
	  int v1;
	  int v2;
	  ...
	  if ( usTrg_KeyPress1Frame[0] & 1 ) // Hold A
	    Wario_ucJpNext = 1;
	  ...
	  if ( (Wario_usMukiX ^ 0x30) & KeyPressContinuous[0] ) // Hold Left or Right
	  {
	    Wario_usMukiX ^= 0x30;
			airAttackStat = 0; // Custom Code
